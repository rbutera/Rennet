...
const SCREENS = [
  ...
  { f: '23-mobile-publish.png', n: 'Mobile · post', tag: 'Mobile', p: 'The headline: preview → one tap posts, from anywhere. No sign step, no confirmation ceremony — the paper shows exactly what appears under Rai’s name, and the post button is the click. Outcome stated truthfully with the real URL; own-branch flow ends the same way (draft body → post → idempotent PR).', feats: [] },
