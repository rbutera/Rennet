...
const SCREENS = [
  ...
  { f: '01-first-run.png', n: 'First run', tag: 'Onboarding', p: 'The empty projects list. Add-a-project is the whole onboarding; harness detection is one ambient backlight line (gh gone — v4.2). New: a skippable Connect-GitHub card — one-time OAuth device sign-in, asked again lazily at point of need, never a wall. No wizard, no ceremony.', feats: [] },
  ...
  { f: '12-collation-draft.png', n: 'Collation draft', tag: 'Draft', p: 'The one editable draft before post. Merge, split, reorder, withdraw, and converse on staged chunks. The orchestrator proposes; you dispose. In v4.0 it is a crumb child of the review (… › feat/rate-limiting › Draft) — one crumb-click or Esc ascends back. Editing lives here.', feats: [] },
  { f: '13-publish-preview.png', n: 'Publish preview', tag: 'Post', p: 'The one solid object. It previews exactly what will post; the verdict is derived from your dispositions and override-able, and the human post carries it. A crumb child of the Draft (… › Draft › Preview); back lands on the Draft, where editing lives. The post in the loop is the safety.', feats: [] },
  ...
  { f: '21-mobile-review-detail.png', n: 'Mobile · review detail & digest', tag: 'Mobile', p: 'Reading at phone width: delta digest counts and rows lead, findings open one at a time for one-tap judgement, and the whole review is readable — the full sequence canvas renders complete (virtualized, judged cohorts collapse) in reading order. The digest is the entry point, never a boundary.', feats: [] },
  ...
  { f: '23-mobile-publish.png', n: 'Mobile · post', tag: 'Mobile', p: 'The headline: preview → one tap posts, from anywhere. No extra step, no confirmation ceremony — the preview shows exactly what appears under Rai’s name, and the post button is the click. Outcome stated truthfully with the real URL; own-branch flow ends the same way (draft body → post → idempotent PR).', feats: [] },
...
<footer><div class="wrap">Rennet wireframes v4.2 &middot; GitHub device sign-in &middot; the mobile set (phase 6 gate) &middot; v3.3 plus a coherent navigation model &middot; HTML sources in wireframes/src, iterable further.</div></footer>`;
