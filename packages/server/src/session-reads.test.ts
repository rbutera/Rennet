...
import { type HarnessEvent, harnessEventsToRows } from "@rennet/core";
import type {
  Review,
  RoundLedgerRecord,
  RoundRecord,
...
describe("the stored transcript: event projection → durable store → dispatch read", () => {
  ...
  it("serves the stored coding turn through the client read", async () => {
