...
// design 15,588 B (the located-specification section, this change); sequence 10,248 B; decisions 9,961 B; flagged 10,894 B (single-section + no-gate guards, #927); noise 10,594 B.
