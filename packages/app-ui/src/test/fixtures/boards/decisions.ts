...
import { board, codeRef, decision, prose, section, skip } from "./helpers";
...
export const decisionsBoard: LensBoard = board(
  "decisions",
  "gen1",
  "decisions-gen1",
  [
  ...
  ],
  {
    skippedHunks: [
      skip(
        ...
        "Test coverage of the new records — requirement-coverage material for the Design lane.",
      ),
      skip(
        "packages/adapters/src/index.ts",
        "Mechanical re-export of RefreshLogRecord/tokenKind — a rename-tier hunk.",
      ),
      skip(`${CHANGE}/proposal.md`, "Spec artifact. The Design lane renders the proposal shape."),
    ],
  },
);
