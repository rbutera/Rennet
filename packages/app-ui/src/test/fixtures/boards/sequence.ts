...
import { annotation, board, callout, codeRef, orderStep, prose, section, skip } from "./helpers";
...
export const sequenceBoard: LensBoard = board(
  "sequence",
  "gen1",
  "sequence-gen1",
  [
  ...
  {
    skippedHunks: [
      skip(`${CHANGE}/design.md`, "spec artifact — Design lens"),
      skip(
        "packages/adapters/src/index.ts",
        "mechanical barrel re-export of RefreshLogRecord and tokenKind; both taught at earlier stops",
      ),
    ],
  },
);
