...
import { type IssueTrackerSettings, type TrackerKind, useSettingsProjection } from "../data";
...
// the review agents. The choice is github / jira / linear / none, resolved through
// the layered ladder — a scout pick lands "detected", a user pick lands "global", a
// project whose scout found nothing reads "none" (no guess). The layer is NOT badged
// on this surface; the controls and their values are the whole story here.
//
