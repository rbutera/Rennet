...
The vendored shadcn/ui component kit, built on Base UI (`@base-ui-components/react`). This package owns Rennet's primitive components; `@rennet/app-ui` composes them into screens.
