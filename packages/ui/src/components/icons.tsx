...
/** GitHub — the octocat outline (Lucide geometry, drawn on its native 24-grid). */
export const GitHubIcon = (p: IconProps) => (
  <Icon viewBox="0 0 24 24" strokeWidth={2.2} {...p}>
...
export const ICON_LEGEND: Record<string, LegendEntry> = {
  // Objects
  GitHubIcon: { entry: "GitHub account", group: "objects" },
