...
// `sm` is 28×16 with a 12px thumb — the spike's settings-row proportions. It was 24×14,
// which read as a different control beside the spike's rows; the thumb size is unchanged,
// so the extra 4×2 is track, not knob. The 14px checked travel is the track's content box
// (28px less the 1px transparent border each side) minus the 12px thumb, which is why it
// is a fixed step rather than `default`'s thumb-relative `calc(100% - 2px)`.
//
