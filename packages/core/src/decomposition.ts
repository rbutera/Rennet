...
//
// The path tables (lockfile / vendored / generated) and the generated-banner
// vocabulary live in `./file-classification`, shared with the repo-wide snapshot
// classifier so a changeset and the map agree about the same path. What stays
// here is the part that is genuinely DIFF-SHAPED: git's binary and submodule
// sentinels, and the header walk that has to track new-file line numbers through
// a hunk body.
