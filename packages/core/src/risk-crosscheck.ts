...
export function attachRiskCrossCheck(
  ...
  // reference the hypothesis's content-addressed `riskId`s. They still travel together
  // because the frame needs both the risk content and its reconciliation status.
  return {
    ...review,
