...
import { ModelSelection, ThreadLinkedPullRequest, TurnMcpServers } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.mcpServers === undefined || row.mcpServers === null ? null : JSON.stringify(row.mcpServers)},
