...
| `rennet-core` | `@rennet/core` | `packages/core` | Review behavior and domain workflows | protocol, instructions |
| `rennet-adapters` | `@rennet/adapters` | `packages/adapters` | Git, GitHub, filesystem, persistence, and harness integrations | protocol, instructions, core |
| `rennet-server` | `@rennet/server` | `packages/server` | Daemon composition, command dispatch, and network transport | protocol, instructions, core, adapters |
