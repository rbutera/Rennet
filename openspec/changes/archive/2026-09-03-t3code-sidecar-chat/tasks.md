...
_8.4: bundle delta measured and recorded in `docs/developing/concepts/t3code-sidecar.md` (startup +24 KB, lazy T3 payload 3.1 MB + 380 KB CSS). WebSocket coexistence is observed in the same manual drive as 6.2._
