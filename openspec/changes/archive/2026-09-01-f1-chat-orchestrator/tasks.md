...
- [x] 7.1 `packages/core/src/harness.ts`: `SessionSpec.inProcessTools?: readonly InProcessTool[]`, where [archive 2026-09-01: landed — buildAppTools consumed at create-server toolsForReview; #570 closed]
...
- [x] 7.2 `packages/adapters/src/claude-query.ts` + `claude-adapter.ts`: map the descriptors onto the [archive 2026-09-01: landed — buildAppTools consumed at create-server toolsForReview; #570 closed]
  ...
  them.
- [x] 7.3 `packages/server/src/create-server.ts`: pass `buildAppTools(dispatch)` into the ask's session [archive 2026-09-01: landed — buildAppTools consumed at create-server toolsForReview; #570 closed]
  ...
  dispatch instance.
- [x] 7.4 **Live proof, not a unit test:** ask the orchestrator in the real chat dock to perform a real [archive 2026-09-01: landed — buildAppTools consumed at create-server toolsForReview; #570 closed]
