...
This change is retired. Issue #71 is closed. The shared progress feed, processing narration, replay, and artifact navigation remain current. The unchecked consumers describe an expansion that is not part of the accepted capability and must not be treated as unfinished debt.
