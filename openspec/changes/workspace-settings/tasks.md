...
- [x] 5.4 PR description states: no prompt, interpolation, tool surface or settings surface a session SENDS changes; the settings surface the VIEWER sees grows by four controls and a list
