...
- [x] 2.7 The round card: after a push under `own`, one line says the local branch is behind its upstream; the land action sits beside it with D4's refusal copy when refused. The no-self-explaining-chrome rule: the line names the branch, not Rennet's machinery
