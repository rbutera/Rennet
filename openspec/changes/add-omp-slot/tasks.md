...
- [x] 6.4 PR closes #26; the closing note states the flag posture honestly (descriptor exists, all capability layers `false` pending the first gated real run) and where `RENNET_LIVE_OMP=1` earns them.
