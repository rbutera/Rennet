---
title: "Rennet User Journey"
description: "The canonical, ordered account of the user's day in Rennet. Every step below was designed somewhere (the prototype, the plans, the issue queue), but no..."
---

> Migrated from `docs/Rennet User Journey.md`.
