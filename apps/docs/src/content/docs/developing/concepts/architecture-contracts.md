---
title: "Rennet Architecture Contracts"
description: "This note is the authoritative contract for project context, review snapshots, persistence, harness access, and publication in [[Code Review Harness App..."
---

> Migrated from `docs/Rennet Architecture Contracts.md`.
