---
title: "Rennet Doc Architecture"
description: "The map of every document in docs/: which role each plays, how they cross-link, and which are historical. Consolidated 2026-08-06 (Rai: turn the docs an..."
---

> Migrated from `docs/Rennet Doc Architecture.md`.
