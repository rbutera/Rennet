---
title: "Rennet Delivery Order"
description: "Purpose: if you are an agent about to build something in this repo, read this first and pick your work from here. It outranks the ordering implied by is..."
---

> Migrated from `docs/Rennet Delivery Order.md`.
