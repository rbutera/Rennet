...
Generated from the resolved production graph: 768 packages across 18 licence buckets. Regenerate with `pnpm notices`.
...
- **@expo-google-fonts/dm-sans** 0.4.2 — https://github.com/expo/google-fonts/tree/master/font-packages/dm-sans#readme
...
- **@fontsource-variable/dm-sans** 5.3.0 — https://fontsource.org/fonts/dm-sans
- **@fontsource-variable/fraunces** 5.3.0 — https://fontsource.org/fonts/fraunces
- **@fontsource-variable/source-serif-4** 5.3.0 — https://fontsource.org/fonts/source-serif-4
